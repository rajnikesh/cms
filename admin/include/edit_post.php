...
if(isset($_GET['p_id'])){
 ...
 while($row=mysqli_fetch_assoc($result)){
     ...
     $query="UPDATE post SET ";
         ...
         echo "<p class='bg-success'>Post Updated. <a href='../post.php?p_id={$post_id}'>View Post</a> or <a href='post.php'>Edit More Post</a></p>";
     }                          
?>
   ...
   <form action="" method="post" enctype="multipart/form-data">
    ...
    <!--<div class="form-group">
        ...
        <input value=" type="text" class="form-control" name='status'>
    </div>-->
    <div class="form-group">
